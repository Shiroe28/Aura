...
- `goals`: Yearly goals and resolutions
- `todos`: Daily tasks
- `calendar_events`: Scheduled events
- `daily_reflections`: Morning intentions and evening reflections
...
**Issue**: "Invalid Supabase URL or API key"
- **Solution**: Double-check your credentials in `lib/main.dart`

**Issue**: "Can't create todos/goals"
- **Solution**: Make sure you've run the SQL schema in Supabase

**Issue**: Font not loading
- **Solution**: Verify font files are in `assets/fonts/` or remove font configuration from `pubspec.yaml`
...
- Built with love using Flutter and Supabase
